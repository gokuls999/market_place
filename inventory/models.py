...
class Sellers(models.Model):
    ...
    documents = models.FileField(upload_to='seller_docs/', blank=True)  # For business docs
...
class Orders(models.Model):
    ...
    status = models.CharField(
        max_length=20,
        choices=[('placed', 'Placed'), ('processing', 'Processing'), ('shipped', 'Shipped'), ('delivered', 'Delivered'), ('cancelled', 'Cancelled')],
        default='placed'
    )
